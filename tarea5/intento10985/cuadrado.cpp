...
cuadrado::cuadrado(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::cuadrado)
{
    ui->setupUi(this);
...
void cuadrado::paintEvent(QPaintEvent *e)
{
...
void cuadrado::imprimeCuadrado(QPainter &painter){
    int x1 = -25;
    int y1 = 25;
    int x2 = 25;
    int y2 = 25;
...
/*Zoom*/
void cuadrado::on_pushButton_clicked()
{
    float z;
...
/*trans*/
void cuadrado::on_okTras_clicked()
{
...
/*refle*/
void cuadrado::on_pushButton_4_clicked()
{
    QTransform esca;
    esca.scale(-1,1);
...
/*Rotacion*/
void cuadrado::on_pushButton_2_clicked()
{
